...
- [Harvard CS249r: TinyML Fundamentals on EdX](https://www.edx.org/learn/machine-learning/harvard-university-fundamentals-of-tinyml) – World-renowned free Harvard course covering fundamentals of Tiny Machine Learning including applications, algorithms, hardware, and hands-on deployment on microcontrollers. Taught by top experts from Harvard and Google. (🟢 Beginner)
...
**See also:**
- [Deep Learning & Neural Networks](./deep-learning-neural-networks.md) - Models to deploy on edge
- [Computer Vision](./computer-vision.md) - Vision models for edge cameras
- [MLOps](./mlops.md) - Deployment and monitoring practices
- [AI Tools & Frameworks](./ai-tools-frameworks.md) - ML frameworks and libraries
- [AI Security & Privacy](./ai-security-privacy.md) - Federated learning and differential privacy
