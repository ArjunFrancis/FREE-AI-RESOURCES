...
Advanced neural network architectures designed for learning from graph-structured data, enabling powerful applications in social networks, molecules, knowledge graphs, and recommendation systems.

## 📖 Overview
Graph Neural Networks (GNNs) extend deep learning to non-Euclidean data structures like graphs and networks. Unlike traditional neural networks that work with grid-structured data (images, text), GNNs can process irregular graph structures where nodes represent entities and edges represent relationships. GNNs have revolutionized fields like drug discovery, social network analysis, traffic prediction, and recommendation systems.

**Keywords:** graph neural networks, GNN, PyTorch Geometric, graph learning, node classification, link prediction, graph classification, message passing, graph convolutional networks, graph attention networks, network analysis
...
- [Stanford CS224W: Machine Learning with Graphs](https://web.stanford.edu/class/cs224w/) – The definitive course on graph machine learning taught by Jure Leskovec at Stanford. Covers GNNs, knowledge graphs, graph generation, deep graph generative models. Lectures, assignments, and Colab notebooks available. (🔴 Advanced)
  - 📖 Access: Fully open, lecture videos + materials
  - 🏛️ Authority: Stanford University (Jure Leskovec)
...
- [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) – Leading GNN library for PyTorch with 21k+ stars, extensive model zoo, and active development
- [Deep Graph Library (DGL)](https://www.dgl.ai/) – Python package for deep learning on graphs, supports PyTorch, TensorFlow, and MXNet
- [Spektral](https://graphneural.network/) – GNN library for Keras and TensorFlow 2
- [NetworkX](https://networkx.org/) – Python package for graph creation, manipulation, and analysis
...
**See also:**
- [Deep Learning & Neural Networks](./deep-learning-neural-networks.md) – Neural network fundamentals, optimization
- [Computer Vision](./computer-vision.md) – CNNs and visual recognition (geometric deep learning connection)
- [Datasets & Benchmarks](./datasets-benchmarks.md) – Graph datasets for training and evaluation
- [Mathematics for AI](./mathematics-for-ai.md) – Linear algebra, graph theory foundations
- [Reinforcement Learning](./reinforcement-learning.md) – RL on graphs

**Cross-reference:**
- For graph theory foundations → See Mathematics for AI
- For deep learning basics → See Deep Learning & Neural Networks
- For molecular applications → See AI for Healthcare

**Prerequisites:**
- Strong Python programming skills
- Understanding of deep learning fundamentals (neural networks, backpropagation)
- Basic graph theory (nodes, edges, adjacency matrices)
